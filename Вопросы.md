...
$$\iint\limits_{D}\dfrac{\partial P}{\partial y}dx\,dy=\int\limits_{a}^{b}dx\int\limits_{y_1(x)}^{y_2(x)}\dfrac{\partial P}{\partial y}dy=\int\limits_{a}^{b}dx[P(x,y_2(x))-P(x,y_1(x))]dy$$
