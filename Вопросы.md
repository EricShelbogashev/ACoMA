...
$$(6)\quad\iint\limits_{D}\dfrac{\partial P}{\partial y}dx\,dy=-\int\limits_{C}P(x,y)\,dx$$
Аналогично доказывается и по $Q$
$$(7)\quad\iint\limits_{D}\dfrac{\partial Q}{\partial x}dx\,dy=-\int\limits_{C}P(x,y)\,dx$$
