...
Т.к. $A, \space B$ - сложные функции. Поставим производные (не везде), используя правила производной произведения и сложной функции 
$$I=\iint\limits_\Omega\left(\dfrac{\partial P}{\partial f}\dfrac{\partial f}{\partial u}+\dfrac{\partial P}{\partial g}{\dfrac{}{}}\right)\,du\,dv.$$
