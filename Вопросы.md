...
Сократим и перегрупируем $(2$
$$I=\iint\limits_\Omega\left(\dfrac{\partial P}{\partial z}\underbrace{\left(\dfrac{\partial h}{\partial u}\dfrac{\partial f}{dv}-\dfrac{\partial h}{\partial v}\dfrac{\partial f}{\partial u}\right)}_{\large(3)}+\dfrac{\partial P}{\partial y}\underbrace{\left(\dfrac{\partial g}{\partial u}\dfrac{\partial f}{\partial v}-\dfrac{\partial g}{\partial v}\dfrac{\partial f}{\partial u}\right)}_{\large(4)\text{ с минусом}}\right)\,du,dv.$$
...
$(2)\quad A=\dfrac{\partial  g}{\partial  u}\dfrac{\partial h}{\partial v}-\dfrac{\partial  g}{\partial v }\dfrac{\partial h}{\partial u}$

$(3)\quad B=\dfrac{\partial f}{\partial v}\dfrac{\partial h}{\partial u}-\dfrac{\partial f}{\partial u}\dfrac{\partial h}{\partial v}$

$(4)\quad C=\dfrac{\partial f}{\partial u}\dfrac{\partial g}{\partial v}-\dfrac{\partial f}{\partial v}\dfrac{\partial g}{\partial u}$
