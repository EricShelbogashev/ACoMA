...
<mark style="background: #ffffff00; color: #E53935">7.</mark> $G \subset \mathbb{R}^3$ - область такая, что $S \subset G$ и $P(x,y,z)$, $Q(x,y,z)$, $R(x,y,z)$ определены при $(x,y,z) \in G$.
...
$$(1)\quad I=\int\limits_\gamma P(x,y,z)\,dx=\int\limits_a^bP(f,g,h)\dfrac{\partial f}{\partial t}\,dt,$$
где 
$\quad f = f(u(t),v(t))$
$\quad g = g(u(t),v(t))$
$\quad h = h(u(t),v(t))$
производная сложной функции ($u'=u'(t)$, запись $u_t'$ для наглядности)
...
$$=\int\limits_{\gamma_0} P(f,g,h)[f_u'\,du+f_v'\,dv].$$
...
Пусть
$$P_1=P(f,g,h)\,f_u'\,du \,,\quad Q_1=P(f,g,h)\,f_v'\,dv.$$
Так как $(2)$ $\Phi$ дважды-дифференцируема (т.е. $f,g,h,f_u', f_v'$ ), $P$ также непрерывна и имеет непрерывные производные в $G$ $(8)$, используя $(3,4)$ воспользуемся формулой Грина: 
$$I=\int\limits_{\gamma_0}(P_1\,du+Q_1\,dv)=$$
