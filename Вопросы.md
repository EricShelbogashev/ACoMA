...
Пусть
$$P_1=P(f,g,h)\,f_u'\,du \,,\quad P_2=P(f,g,h)\,f_v'\,dv.$$
...
$$I=\oint\limits_{\gamma_0}(P_1\,du+Q_1\,dv)=\iint\limits_\Omega\left(\dfrac{\partial Q_1}{\partial u}-\dfrac{\partial P_1}{\partial v}\right)\,du\,dv.$$
Т.к. $P_1, \space Q_1$ - сложные функции. Поставим производные, используя правила производной произведения и сложной функции
$$I=\iint\limits_\Omega\left(\dfrac{\partial Q_1}{\partial }\right)\,du\,dv.$$
