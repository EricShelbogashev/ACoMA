...
$$=\int\limits_{a}^{b}P(x,y_2(x))\,dx-\int\limits_{a}^{b}P(x,y_1(x))\,dx$$
Оба интеграла представим как криволинейные интегралы $II$ рода
$$1.\quad\int\limits_{a}^{b}P(x,y_2(x))\,dx=\int\limits_{C_1}P(x,y)\,dx$$
$$2.\quad $$\int\limits_{a}^{b}P(x,y_2(x))\,dx=\int\limits_{C_1}P(x,y)\,dx$$
