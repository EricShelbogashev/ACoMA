...
Т.к. $A, \space B$ - сложные функции. Поставим производные, используя правила производной произведения и сложной функции
$$I=\iint\limits_\Omega\left(\dfrac{\partial B}{\partial u}\dfrac{f}{}\right)\,du\,dv.$$
