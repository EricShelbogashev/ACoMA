...
$$I=\iint\limits_\Omega\left(\dfrac{\partial P}{\partial z}\left(\dfrac{\partial h}{\partial u}\dfrac{\partial f}{dv}-\dfrac{\partial h}{\partial v}\dfrac{\partial f}{\partial u}\right)+\dfrac{\partial P}{\partial y}\left(\underbrace{\dfrac{\partial g}{\partial u}\dfrac{\partial f}{\partial v}-\dfrac{\partial g}{\partial v}\dfrac{\partial f}{\partial u}}_{\large(4)\text{ с минусом}}\right)\right)\,du,dv.$$
