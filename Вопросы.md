...
Т.к. $A, \space B$ - сложные функции. Поставим производные, используя правила производной произведения и сложной функции и учитывая $f=x,\space g=y,\space h=z$ на их областях определения и 
